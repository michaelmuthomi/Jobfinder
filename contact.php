...
<body data-bs-spy="scroll">
   <div id="container">
      ...
      ?>
      <div id="wb_Text1">
         <span id="wb_uid0">Contact Us </span><span id="wb_uid1">.</span>
      </div>
      <form action="contact" method="post">
         <button type="submit" id="send" name="send" value="Send" class="ui-button ui-corner-all">Send</button>
         <div id="wb_Text2">
            <span id="wb_uid2">Tell Us Something</span>
         </div>
         <div id="wb_message">
            <input type="text" id="message" name="message" value="" spellcheck="false" placeholder="Message" required>
            <label id="message-label" for="message">Message</label>
         </div>
         <?php
         $value = "SELECT * FROM credentials WHERE id=".$_SESSION['id']."";
         $getvalue = mysqli_query($dbconn, $value);
         $process = mysqli_fetch_assoc($getvalue);
         if ($process) {
            echo '<div id="wb_email">
            <input type="email" id="email" name="email" value="' . $process['email'] . '" maxlength="50" spellcheck="false" placeholder="Email">
            ...
            <div class="container">
               ...
               <div class="DropdownMenu1-navbar-collapse collapse">
                  <ul class="nav navbar-nav" itemscope="itemscope" itemtype="https://schema.org/SiteNavigationElement">
                     ...
                     <li itemprop="name" class="nav-item">
                        <a href="./contact" class="nav-link active" itemprop="url">Contact us</a>
                     </li>
                     <li itemprop="name" class="nav-item">
